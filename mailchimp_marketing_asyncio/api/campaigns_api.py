...
class CampaignsApi(object):
    ...
    def list(self, **kwargs):  # noqa: E501
        ...
        :param datetime before_create_time: Restrict the response to campaigns created before the set time. Uses ISO 8601 time format: 2015-10-21T15:41:36+00:00.
        :param datetime since_create_time: Restrict the response to campaigns created after the set time. Uses ISO 8601 time format: 2015-10-21T15:41:36+00:00.
