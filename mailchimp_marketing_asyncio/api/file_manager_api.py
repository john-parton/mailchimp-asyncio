...
class FileManagerApi(object):
    ...
    def files(self, **kwargs):  # noqa: E501
        ...
        :param str before_created_at: Restrict the response to files created before the set date. Uses ISO 8601 time format: 2015-10-21T15:41:36+00:00.
        :param str since_created_at: Restrict the response to files created after the set date. Uses ISO 8601 time format: 2015-10-21T15:41:36+00:00.
