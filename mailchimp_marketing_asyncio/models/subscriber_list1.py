...
class SubscriberList1(object):
    ...
    def __init__(self, name=None, contact=None, permission_reminder=None, use_archive_bar=False, campaign_defaults=None, notify_on_subscribe='false', notify_on_unsubscribe='false', email_type_option=None, double_optin=False, marketing_permissions=False):  # noqa: E501
        """SubscriberList1 - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def name(self):
        """Gets the name of this SubscriberList1.  # noqa: E501

        The name of the list.  # noqa: E501

        :return: The name of this SubscriberList1.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this SubscriberList1.

        The name of the list.  # noqa: E501

        :param name: The name of this SubscriberList1.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    @property
    def contact(self):
        """Gets the contact of this SubscriberList1.  # noqa: E501


        :return: The contact of this SubscriberList1.  # noqa: E501
        :rtype: ListContact1
        """
    ...
    def contact(self, contact):
        """Sets the contact of this SubscriberList1.


        :param contact: The contact of this SubscriberList1.  # noqa: E501
        :type: ListContact1
        """
        if contact is None:
    ...
    def permission_reminder(self):
        """Gets the permission_reminder of this SubscriberList1.  # noqa: E501

        The [permission reminder](https://mailchimp.com/help/edit-the-permission-reminder/) for the list.  # noqa: E501

        :return: The permission_reminder of this SubscriberList1.  # noqa: E501
        :rtype: str
        """
    ...
    def permission_reminder(self, permission_reminder):
        """Sets the permission_reminder of this SubscriberList1.

        The [permission reminder](https://mailchimp.com/help/edit-the-permission-reminder/) for the list.  # noqa: E501

        :param permission_reminder: The permission_reminder of this SubscriberList1.  # noqa: E501
        :type: str
        """
    ...
    def use_archive_bar(self):
        """Gets the use_archive_bar of this SubscriberList1.  # noqa: E501
        ...
        :return: The use_archive_bar of this SubscriberList1.  # noqa: E501
        :rtype: bool
        """
    ...
    def use_archive_bar(self, use_archive_bar):
        """Sets the use_archive_bar of this SubscriberList1.

        Whether campaigns for this list use the [Archive Bar](https://mailchimp.com/help/about-email-campaign-archives-and-pages/) in archives by default.  # noqa: E501

        :param use_archive_bar: The use_archive_bar of this SubscriberList1.  # noqa: E501
        :type: bool
        """
    ...
    def campaign_defaults(self):
        """Gets the campaign_defaults of this SubscriberList1.  # noqa: E501


        :return: The campaign_defaults of this SubscriberList1.  # noqa: E501
    ...
    def campaign_defaults(self, campaign_defaults):
        """Sets the campaign_defaults of this SubscriberList1.


        :param campaign_defaults: The campaign_defaults of this SubscriberList1.  # noqa: E501
    ...
    def notify_on_subscribe(self):
        """Gets the notify_on_subscribe of this SubscriberList1.  # noqa: E501
        ...
        :return: The notify_on_subscribe of this SubscriberList1.  # noqa: E501
        :rtype: str
        """
    ...
    def notify_on_subscribe(self, notify_on_subscribe):
        """Sets the notify_on_subscribe of this SubscriberList1.

        The email address to send [subscribe notifications](https://mailchimp.com/help/change-subscribe-and-unsubscribe-notifications/) to.  # noqa: E501

        :param notify_on_subscribe: The notify_on_subscribe of this SubscriberList1.  # noqa: E501
        :type: str
        """
    ...
    def notify_on_unsubscribe(self):
        """Gets the notify_on_unsubscribe of this SubscriberList1.  # noqa: E501
        ...
        :return: The notify_on_unsubscribe of this SubscriberList1.  # noqa: E501
        :rtype: str
        """
    ...
    def notify_on_unsubscribe(self, notify_on_unsubscribe):
        """Sets the notify_on_unsubscribe of this SubscriberList1.

        The email address to send [unsubscribe notifications](https://mailchimp.com/help/change-subscribe-and-unsubscribe-notifications/) to.  # noqa: E501

        :param notify_on_unsubscribe: The notify_on_unsubscribe of this SubscriberList1.  # noqa: E501
        :type: str
        """
    ...
    def email_type_option(self):
        """Gets the email_type_option of this SubscriberList1.  # noqa: E501
        ...
        :return: The email_type_option of this SubscriberList1.  # noqa: E501
        :rtype: bool
        """
    ...
    def email_type_option(self, email_type_option):
        """Sets the email_type_option of this SubscriberList1.

        Whether the list supports [multiple formats for emails](https://mailchimp.com/help/change-audience-name-defaults/). When set to `true`, subscribers can choose whether they want to receive HTML or plain-text emails. When set to `false`, subscribers will receive HTML emails, with a plain-text alternative backup.  # noqa: E501

        :param email_type_option: The email_type_option of this SubscriberList1.  # noqa: E501
        :type: bool
        """
    ...
    def double_optin(self):
        """Gets the double_optin of this SubscriberList1.  # noqa: E501

        Whether or not to require the subscriber to confirm subscription via email.  # noqa: E501

        :return: The double_optin of this SubscriberList1.  # noqa: E501
        :rtype: bool
        """
    ...
    def double_optin(self, double_optin):
        """Sets the double_optin of this SubscriberList1.

        Whether or not to require the subscriber to confirm subscription via email.  # noqa: E501

        :param double_optin: The double_optin of this SubscriberList1.  # noqa: E501
        :type: bool
        """
    ...
    def marketing_permissions(self):
        """Gets the marketing_permissions of this SubscriberList1.  # noqa: E501

        Whether or not the list has marketing permissions (eg. GDPR) enabled.  # noqa: E501

        :return: The marketing_permissions of this SubscriberList1.  # noqa: E501
        :rtype: bool
        """
    ...
    def marketing_permissions(self, marketing_permissions):
        """Sets the marketing_permissions of this SubscriberList1.

        Whether or not the list has marketing permissions (eg. GDPR) enabled.  # noqa: E501

        :param marketing_permissions: The marketing_permissions of this SubscriberList1.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SubscriberList1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubscriberList1):
            return False
