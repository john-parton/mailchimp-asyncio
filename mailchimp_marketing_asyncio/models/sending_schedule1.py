...
class SendingSchedule1(object):
    ...
    def __init__(self, hour=None, daily_send=None, weekly_send_day=None, monthly_send_date=None):  # noqa: E501
        """SendingSchedule1 - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def hour(self):
        """Gets the hour of this SendingSchedule1.  # noqa: E501

        The hour to send the campaign in local time. Acceptable hours are 0-23. For example, '4' would be 4am in [your account's default time zone](https://mailchimp.com/help/set-account-details/).  # noqa: E501

        :return: The hour of this SendingSchedule1.  # noqa: E501
        :rtype: int
        """
        return self._hour
    ...
    @hour.setter
    def hour(self, hour):
        """Sets the hour of this SendingSchedule1.

        The hour to send the campaign in local time. Acceptable hours are 0-23. For example, '4' would be 4am in [your account's default time zone](https://mailchimp.com/help/set-account-details/).  # noqa: E501

        :param hour: The hour of this SendingSchedule1.  # noqa: E501
        :type: int
        """
    ...
    @property
    def daily_send(self):
        """Gets the daily_send of this SendingSchedule1.  # noqa: E501


        :return: The daily_send of this SendingSchedule1.  # noqa: E501
    ...
    def daily_send(self, daily_send):
        """Sets the daily_send of this SendingSchedule1.


        :param daily_send: The daily_send of this SendingSchedule1.  # noqa: E501
    ...
    def weekly_send_day(self):
        """Gets the weekly_send_day of this SendingSchedule1.  # noqa: E501

        The day of the week to send a weekly RSS Campaign.  # noqa: E501

        :return: The weekly_send_day of this SendingSchedule1.  # noqa: E501
        :rtype: str
        """
    ...
    def weekly_send_day(self, weekly_send_day):
        """Sets the weekly_send_day of this SendingSchedule1.

        The day of the week to send a weekly RSS Campaign.  # noqa: E501

        :param weekly_send_day: The weekly_send_day of this SendingSchedule1.  # noqa: E501
        :type: str
        """
    ...
    def monthly_send_date(self):
        """Gets the monthly_send_date of this SendingSchedule1.  # noqa: E501
        ...
        :return: The monthly_send_date of this SendingSchedule1.  # noqa: E501
        :rtype: float
        """
    ...
    def monthly_send_date(self, monthly_send_date):
        """Sets the monthly_send_date of this SendingSchedule1.

        The day of the month to send a monthly RSS Campaign. Acceptable days are 0-31, where '0' is always the last day of a month. Months with fewer than the selected number of days will not have an RSS campaign sent out that day. For example, RSS Campaigns set to send on the 30th will not go out in February.  # noqa: E501

        :param monthly_send_date: The monthly_send_date of this SendingSchedule1.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SendingSchedule1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SendingSchedule1):
            return False
